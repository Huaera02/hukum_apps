              ...
              children: [
                Container(
                  ...
                  child: Column(
                     ...
                     mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      Text('Masukkan Jenjang Pendidikan',
                        style: GoogleFonts.ubuntu(
                        fontSize: 12,
                      ...
                      const SizedBox(height: 20),
                      Text('Masukkan Asal Perguruan Tinggi',
                        style: GoogleFonts.ubuntu(
                        fontSize: 12,
                        fontWeight: FontWeight.w500,
                      ),),
                ...
                Container(
                  ...
                  height: 52,
                  margin: const EdgeInsets.only(left: 26, right: 26, top: 150, bottom: 20),
