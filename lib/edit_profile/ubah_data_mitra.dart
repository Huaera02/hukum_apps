...
import 'package:loginn/profile/tambah_keahlian.dart';
import 'package:loginn/profile/tambah_pendidikan.dart';

class UbahDataMitraView extends StatefulWidget {
  const UbahDataMitraView({super.key});

  @override
  State<UbahDataMitraView> createState() => _UbahDataMitraViewState();
}

class _UbahDataMitraViewState extends State<UbahDataMitraView> {
                          ...
                          Expanded(
                            child: TabBarView(
                              children: [
                                ...
                                //                           //   Navigator.push(context,
                                //                           //   MaterialPageRoute(builder: (context) => const AddPendidikan()));
                                //                           // }, child: Text('Tambah',
                                //                           //   style: GoogleFonts.ubuntu(
                                //                           //   fontSize: 14,
                                //                           //   fontWeight: FontWeight.w500,
                                ...
                                //                         ),
                                //                         Text(
                                //                             'No Kasus: 123/Pdt.G/2020/PN.Jkt.Pst',
                                //                             style: GoogleFonts
                                //                                 .ubuntu(
                                //                               fontSize: 14,
                                //                               fontWeight:
